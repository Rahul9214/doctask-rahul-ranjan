    ...
    <main className="shell">
      <section className="panel" aria-labelledby="page-title">
        ...
        <p className="scope-message">
          ...
          incremental updates, MCP business operations, approved-only register
          publication, and local Compose deployment are implemented. Hosted
          cloud deployment is not.
        </p>
